  ...
  <div class="home">
      <div class="wrapper fadeInDown">
              <div id="formContent">
                ...
                <!-- Login Form -->
                <form>
                    <v-text-field v-model="user.username" label="Correo" > </v-text-field>
                    <VuePassword v-model="user.password" @input="updatePswdStrength" :strength="pswd_strength" placeholder="Password"/>
                    <VuePassword v-model="user.confirmPassword" @input="updateCPswdStrength" :strength="conf_pswd_strength" placeholder="Password confirm"/>
