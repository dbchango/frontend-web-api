      ...
      <div class="wrapper fadeInDown">
              <div id="formContent">
                ...
                <form v-on:submit.prevent="login">
                  <input type="text" id="login" class="fadeIn second" name="login" placeholder="Usuario" v-model="user.username" label="Correo">
                  <input type="text" id="password" class="fadeIn third" name="login" placeholder="Password"  v-model="user.password" @input="updateStrength" :strength="pswd_strength">
                  <input type="submit" class="fadeIn fourth" value="Login" @click="handleLogin">
                  <input type="submit" class="fadeIn fourth" value="Register" @click="handleEnterRegister">
                </form>
